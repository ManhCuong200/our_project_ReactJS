  ...
  return (
    <section className="relative min-h-[680px] bg-[#fff] flex flex-col align-center">
      ...
      <div className="absolute inset-0 flex items-start justify-center pt-[60px] z-10">
        <div className="max-w-7xl mx-auto px-8 lg:px-20 w-full grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          <div className="relative">
            <div className="z-10 relative">
              <h2 className="text-[40px] font-bold text-[#681c66] leading-[1.2] m-0 mb-3">
                Get free consultation
              </h2>
              <p className="text-gray-800 text-lg max-w-lg mb-0 leading-[1.9] font-sans font-normal">
            ...
            <img
              ...
              alt="plane"
              className="absolute -bottom-[260px] left-[-100px] w-full animate-float"
            />
          </div>

          <div className="bg-white rounded-2xl shadow-[0_25px_60px_rgba(0,0,0,0.08)] w-full p-10">
            <form className="flex flex-col space-y-6">
              ...
              <div className="flex items-center justify-between border border-gray-300 bg-white p-2 w-60">
                <div className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    id="not-robot"
                    className="w-12 h-10 border border-gray-300 rounded-sm"
                    aria-label="Tôi không phải là người máy"
                  />
                  <label
                    htmlFor="not-robot"
                    className="text-[14px] cursor-pointer text-gray-950  select-none leading-[1.2]"
                  >
              ...
              <button
                type="submit"
                className="w-full bg-[#6ea544] text-white font-semibold py-4 rounded-lg hover:bg-[#7fb853] transition-all duration-200"
              >
                Get it Now
              </button>
            </form>
      ...
      <div className="fixed right-6 bottom-6 flex flex-col gap-4 z-50">
        ...
        <div className="bg-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg cursor-pointer">
          <img
