...
const Navbar = () => {
  ...
  return (
    <header className="w-full absolute top-0 left-0 z-50 bg-transparent backdrop-blur-sm">
      <div className="flex items-center justify-between px-6 sm:px-[55px] h-[70px] sm:h-[90px]">
        <img
        ...
        <nav className="hidden sm:flex items-center gap-10 text-[16px] font-medium text-white">
          ...
          <div className="flex items-center gap-4 ml-4 relative">
            ...
            <div className="flex items-center gap-1">
              <img
                ...
                alt="US Flag"
                className="w-[4 0px] h-auto object-cover cursor-default"
              />
              <div className="relative group">
                ...
                <div className="absolute right-0 mt-2 w-36 bg-white rounded-lg shadow-lg py-2 text-gray-700 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-200 z-50">
                  ...
                  <div className="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 cursor-pointer">
                    <img
                      src="https://napaglobal.com/img/JP.jpg"
                      alt="Japan"
                      className="w-9 h-auto"
                    />
                    <span>Japan</span>
      ...
      <div
        className={`sm:hidden flex flex-col bg-black/90 text-white text-center text-lg font-medium space-y-4 py-8 transition-all duration-300 ${
          open
            ? "max-h-[500px] opacity-100"
            : "max-h-0 opacity-0 overflow-hidden"
        }`}
      >
        <a href="#" className="hover:text-[#84b857]">
          Company
        </a>
        <a href="#" className="hover:text-[#84b857]">
          Our Services
        ...
        <a
          href="#"
          className="inline-block bg-[#6ea544] text-white font-semibold px-6 py-3 rounded-md mx-auto w-[150px]"
        >
          Contact
        </a>
      </div>
